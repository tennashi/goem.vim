...
execute join(['function! vital#_goem#Web#URI#HTTP#import() abort', printf("return map({'canonicalize': '', 'default_port': ''}, \"vital#_goem#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim
